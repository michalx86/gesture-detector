...
class TestMotionDetector(unittest.TestCase):
  ...
  def test_track_no_oldobj_no_detections(self):
    self.assertEqual(object_tracker.track(None,[]), None , "Should be None")

  def test_track_no_oldobj_1_detection(self):
    ...
    new_obj = object_tracker.track(None,[obj])
  ...
  def test_track_no_oldobj_3_detections(self):
    ...
    new_obj = object_tracker.track(None,[obj1, obj2, obj3])

    self.assertEqual(new_obj, exp_obj, "Should be equal to: {}".format(exp_obj))

  def test_track_oldobj_no_detection(self):
    obj = Object(id=1, score=0.5, bbox=BBox(xmin=1, ymin=1, xmax=2, ymax=2))

    new_obj = object_tracker.track(obj, None)

    self.assertEqual(new_obj, None, "Should be None")

  def test_track_oldobj_1_detection_nointersection(self):
    obj1 = Object(id=1, score=0.6, bbox=BBox(xmin=1, ymin=1, xmax=2, ymax=2))
    ...
    new_obj = object_tracker.track(obj1, [obj2])

    self.assertEqual(new_obj, exp_obj, "Got: {}\nShould be: {}".format(new_obj, exp_obj))

  def test_track_oldobj_1_detection_intersection_with_same_id(self):
  ...
  def test_track_oldobj_1_detection_intersection_with_different_id(self):
    obj1 = Object(id=1, score=0.0, bbox=BBox(xmin=1.0, ymin=1, xmax=3, ymax=3))
